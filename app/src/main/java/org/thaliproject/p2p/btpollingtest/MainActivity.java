...
public class MainActivity extends ActionBarActivity {
    ...
    private ServiceConnection myConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName className, IBinder service) {
            ...
            BtPollingService.MyLocalBinder binder = (BtPollingService.MyLocalBinder) service;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        filter.addAction(BtPollingService.POLLING_VALUES);
            ...
            public void onClick(View v) {
                ...
                if(myService != null){
                    if(isService){
                        myService.Stop();
                        isService = false;
                        stopService(new Intent(that, BtPollingService.class));
                        ((TextView)findViewById(R.id.debugdataBox)).append("Service stopped\n");
                    }else {
                        myService.Start();
                        isService = true;
                        Intent i = new Intent(that, BtPollingService.class);
                        startService(i);
    ...
    private class MainBCReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BtPollingService.POLLING_VALUES.equals(action)) {
                String s = intent.getStringExtra(BtPollingService.POLLING_MESSAGE);
